  ...
  return (
    <section className="relative overflow-hidden bg-maroon">
      ...
      <div
        ...
        aria-hidden
      />
      <div className="relative mx-auto max-w-7xl px-4 py-16 text-center sm:py-20 lg:px-8">
        <Ornament className="mb-5 text-gold-light/80" />
        <h1 className="text-4xl text-saffron-light sm:text-5xl">{title}</h1>
        {subtitle && (
          <p className="mx-auto mt-4 max-w-2xl text-cream/85">{subtitle}</p>
        )}
      </div>
    </section>
  );
